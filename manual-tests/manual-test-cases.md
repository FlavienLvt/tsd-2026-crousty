...
| **TC-004** | Login with wrong password | Authentication | Medium | Negative | User is registered | Valid email, invalid password | 1. Go to Login page<br>2. Enter credentials<br>3. Click 'Log in' | Error message "Login was unsuccessful" is displayed. | No |
